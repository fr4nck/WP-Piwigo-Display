...
final class WPD_Settings
{
    ...
    private static function render_shortcode_examples(): void
    {
        $examples = [
            ...
            __('Orientation paysage', 'wp-piwigo-display') => '[piwigo album="154" orientation="landscape"]',
            __('Orientation carrée', 'wp-piwigo-display') => '[piwigo album="154" orientation="square"]',
