...
$requirements = array(
	...
	'cache HIT counter remains present'  => false !== strpos( $metrics, "'cache_hits'" ),
	'cache MISS counter remains present' => false !== strpos( $metrics, "'cache_misses'" ),
	'elapsed API time remains present'   => false !== strpos( $metrics, "'elapsed_ms'" ),
