...
foreach (['WPD_Plugin', 'WPD_Settings', 'WPD_Api', 'WPD_Cache', 'WPD_Diagnostic', 'WPD_Renderer', 'WPD_Shortcode', 'WPD_Block', 'WPD_Classic_Editor'] as $wpd_class) {
