...
$wp_piwigo_display_loaded_classes = array(
	'WPD_Plugin', 'WPD_Settings', 'WPD_Service_Account', 'WPD_Service_Api', 'WPD_Api_Metrics', 'WPD_Api', 'WPD_Cache', 'WPD_Diagnostic', 'WPD_Renderer', 'WPD_Shortcode', 'WPD_Block', 'WPD_Classic_Editor', 'WPD_Slider_Transitions', 'WPD_Masonry', 'WPD_Justified', 'WPD_Collage', 'WPD_Composer_Parity', 'WPD_Gutenberg_Parity', 'WPD_Shapes', 'WPD_Piwigo_Response_Compat',
);
